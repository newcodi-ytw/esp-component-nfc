...
void phApp_PrintTech(uint8_t TechType)
{
    ...
    case PHAC_DISCLOOP_POS_BIT_MASK_A:
        MY_DEBUG_PRINT2 ("\tResolving Type A... \n");
        break;

    case PHAC_DISCLOOP_POS_BIT_MASK_B:
        MY_DEBUG_PRINT2 ("\tResolving Type B... \n");
        break;

    case PHAC_DISCLOOP_POS_BIT_MASK_F212:
        MY_DEBUG_PRINT2 ("\tResolving Type F with baud rate 212... \n");
        break;

    case PHAC_DISCLOOP_POS_BIT_MASK_F424:
        MY_DEBUG_PRINT2 ("\tResolving Type F with baud rate 424... \n");
        break;

    case PHAC_DISCLOOP_POS_BIT_MASK_V:
        MY_DEBUG_PRINT2 ("\tResolving Type V... \n");
        break;
...
void phApp_PrintTagInfo(phacDiscLoop_Sw_DataParams_t *pDataParams, uint16_t wNumberOfTags, uint16_t wTagsDetected)
{
    ...
    if (PHAC_DISCLOOP_CHECK_ANDMASK(wTagsDetected, PHAC_DISCLOOP_POS_BIT_MASK_A))
    {
        ...
        {
            MY_DEBUG_PRINT2("\tTechnology  : Type A");
            MY_DEBUG_PRINT2 ("\n\t\tUID :");
    ...
    {
        MY_DEBUG_PRINT2("\tTechnology  : Type B");
    ...
    {
        MY_DEBUG_PRINT2("\tTechnology  : Type F");
    ...
    {
        MY_DEBUG_PRINT2("\tTechnology  : Type V / ISO 15693 / T5T");
    ...
    {
        MY_DEBUG_PRINT2("\tTechnology  : ISO 18000p3m3 / EPC Gen2");
...
void PrintErrorInfo(phStatus_t wStatus)
{
    ...
    {
    case PH_COMP_BAL:
        MY_DEBUG_PRINT2("\t PH_COMP_BAL");
        break;
    case PH_COMP_HAL:
        MY_DEBUG_PRINT2("\t PH_COMP_HAL");
        break;
    case PH_COMP_PAL_ISO14443P3A:
        MY_DEBUG_PRINT2("\t PH_COMP_PAL_ISO14443P3A");
        break;
    case PH_COMP_PAL_ISO14443P3B:
        MY_DEBUG_PRINT2("\t PH_COMP_PAL_ISO14443P3B");
        break;
    case PH_COMP_PAL_ISO14443P4A:
        MY_DEBUG_PRINT2("\t PH_COMP_PAL_ISO14443P4A");
        break;
    case PH_COMP_PAL_ISO14443P4:
        MY_DEBUG_PRINT2("\t PH_COMP_PAL_ISO14443P4");
        break;
    case PH_COMP_PAL_FELICA:
        MY_DEBUG_PRINT2("\t PH_COMP_PAL_FELICA");
        break;
    case PH_COMP_PAL_EPCUID:
        MY_DEBUG_PRINT2("\t PH_COMP_PAL_EPCUID");
        break;
    case PH_COMP_PAL_SLI15693:
        MY_DEBUG_PRINT2("\t PH_COMP_PAL_SLI15693");
        break;
    case PH_COMP_PAL_I18000P3M3:
        MY_DEBUG_PRINT2("\t PH_COMP_PAL_I18000P3M3");
        break;
    case PH_COMP_PAL_I18092MPI:
        MY_DEBUG_PRINT2("\t PH_COMP_PAL_I18092MPI");
        break;
    case PH_COMP_PAL_I18092MT:
        MY_DEBUG_PRINT2("\t PH_COMP_PAL_I18092MT");
        break;
    case PH_COMP_PAL_I14443P4MC:
        MY_DEBUG_PRINT2("\t PH_COMP_PAL_I14443P4MC");
        break;
    case PH_COMP_AC_DISCLOOP:
        MY_DEBUG_PRINT2("\t PH_COMP_AC_DISCLOOP");
        break;
    case PH_COMP_OSAL:
        MY_DEBUG_PRINT2("\t PH_COMP_OSAL");
        break;
    default:
        MY_DEBUG_PRINT2("\t 0x%x",(wStatus & PH_COMPID_MASK));
        break;
    }

    MY_DEBUG_PRINT2("\t type:");

    switch(wStatus & PH_ERR_MASK)
    {
    case PH_ERR_SUCCESS_INCOMPLETE_BYTE:
        MY_DEBUG_PRINT2("\t PH_ERR_SUCCESS_INCOMPLETE_BYTE");
        break;
    case PH_ERR_IO_TIMEOUT:
        MY_DEBUG_PRINT2("\t PH_ERR_IO_TIMEOUT");
        break;
    case PH_ERR_INTEGRITY_ERROR:
        MY_DEBUG_PRINT2("\t PH_ERR_INTEGRITY_ERROR");
        break;
    case PH_ERR_COLLISION_ERROR:
        MY_DEBUG_PRINT2("\t PH_ERR_COLLISION_ERROR");
        break;
    case PH_ERR_BUFFER_OVERFLOW:
        MY_DEBUG_PRINT2("\t PH_ERR_BUFFER_OVERFLOW");
        break;
    case PH_ERR_FRAMING_ERROR:
        MY_DEBUG_PRINT2("\t PH_ERR_FRAMING_ERROR");
        break;
    case PH_ERR_PROTOCOL_ERROR:
        MY_DEBUG_PRINT2("\t PH_ERR_PROTOCOL_ERROR");
        break;
    case PH_ERR_RF_ERROR:
        MY_DEBUG_PRINT2("\t PH_ERR_RF_ERROR");
        break;
    case PH_ERR_EXT_RF_ERROR:
        MY_DEBUG_PRINT2("\t PH_ERR_EXT_RF_ERROR");
        break;
    case PH_ERR_NOISE_ERROR:
        MY_DEBUG_PRINT2("\t PH_ERR_NOISE_ERROR");
        break;
    case PH_ERR_ABORTED:
        MY_DEBUG_PRINT2("\t PH_ERR_ABORTED");
        break;
    case PH_ERR_INTERNAL_ERROR:
        MY_DEBUG_PRINT2("\t PH_ERR_INTERNAL_ERROR");
        break;
    case PH_ERR_INVALID_DATA_PARAMS:
        MY_DEBUG_PRINT2("\t PH_ERR_INVALID_DATA_PARAMS");
        break;
    case PH_ERR_INVALID_PARAMETER:
        MY_DEBUG_PRINT2("\t PH_ERR_INVALID_PARAMETER");
        break;
    case PH_ERR_PARAMETER_OVERFLOW:
        MY_DEBUG_PRINT2("\t PH_ERR_PARAMETER_OVERFLOW");
        break;
    case PH_ERR_UNSUPPORTED_PARAMETER:
        MY_DEBUG_PRINT2("\t PH_ERR_UNSUPPORTED_PARAMETER");
        break;
    case PH_ERR_OSAL_ERROR:
        MY_DEBUG_PRINT2("\t PH_ERR_OSAL_ERROR");
        break;
    case PHAC_DISCLOOP_LPCD_NO_TECH_DETECTED:
        MY_DEBUG_PRINT2("\t PHAC_DISCLOOP_LPCD_NO_TECH_DETECTED");
        break;
    case PHAC_DISCLOOP_COLLISION_PENDING:
        MY_DEBUG_PRINT2("\t PHAC_DISCLOOP_COLLISION_PENDING");
        break;
    default:
        MY_DEBUG_PRINT2("\t 0x%x",(wStatus & PH_ERR_MASK));
        break;
    }
}
