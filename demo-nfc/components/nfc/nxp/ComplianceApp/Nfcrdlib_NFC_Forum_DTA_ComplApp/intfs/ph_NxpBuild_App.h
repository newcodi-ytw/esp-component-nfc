...
#define NXPBUILD__PHHAL_HW_PN5190                         /**< PN5190 HAL Component is included */
    ...
    defined(NXPBUILD_DTA_CE_DEVICE_CLASS)
...
#ifdef NXPBUILD__PHHAL_HW_TARGET                           /**< If FE HAL is RC663, then exclude ISO14443 Card Mode PAL & ISO18092 Target Mode PAL, otherwise include as required. */
...
//        #define NXPBUILD__PHCE_T4T_SW                           /**< AL HCE T4AT SW Component is included */
    #endif
...
#define PH_NXPNFCRDLIB_CONFIG_MAX_NDEF_DATA        0x800U        /**< Maximum NDEF DATA that can be exchanged at a time */
#endif /* NXPBUILD__PHHAL_HW_PN76XX */

#define PHAC_DISCLOOP_CFG_MAX_CARDS_SUPPORTED            0x02U   /**< Maximum cards supported */
#define PHAC_DISCLOOP_CFG_MAX_VICINITY_CARDS_SUPPORTED   0x02U   /**< Maximum vicinity cards supported */

#ifdef NXPBUILD__PHHAL_HW_PN7462AU
#define PH_NXPNFCRDLIB_CONFIG_HAL_TX_BUFFSIZE      (256U)         /* HAL TX buffer Size 256 bytes */
#define PH_NXPNFCRDLIB_CONFIG_HAL_RX_BUFFSIZE      (512U)         /* HAL RX buffer Size 512 bytes */
#else
#define PH_NXPNFCRDLIB_CONFIG_HAL_TX_BUFFSIZE      (560U)         /* HAL TX buffer Size 560 bytes */
#define PH_NXPNFCRDLIB_CONFIG_HAL_RX_BUFFSIZE      (560U)         /* HAL RX buffer Size 560 bytes */
