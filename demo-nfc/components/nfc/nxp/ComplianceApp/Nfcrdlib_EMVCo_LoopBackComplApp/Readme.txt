...
16 Running Nfcrdlib_EMVCo_LoopBackComplApp
...
==================
  ...
  Nfcrdlib_EMVCo_LoopBackComplApp example as well as it's known problems
  and restrictions.
...
====================================================
  ...
  - Nfcrdlib_EMVCo_LoopBackComplApp can be run with CLEV663B, PN5180,
    PN5190 and PN7462AU.  (See Section-17 for supported versions)
  This example is a LoopBack Application which is used to perform EMVCo
  3.1(L1) digital/analog compliance validation.  The CPU frequency
  configured for the Host controller platforms should be sufficient
...
=================================================
  ...
  - Nfcrdlib_EMVCo_LoopBackComplApp is restricted to be run on NFC
    Reader Boards/ICs mentioned in Section-17.
...
===================================================
  ...
  - This example can be used for running EMVCo 3.1(L1) digital/analog
    compliance validation.
  - This example has been verified using the NI/Micropross MP500 Test
    Tool.
...
==========================================
  ...
  The application can used with EMVCo 3.1 Test suite for validation.
