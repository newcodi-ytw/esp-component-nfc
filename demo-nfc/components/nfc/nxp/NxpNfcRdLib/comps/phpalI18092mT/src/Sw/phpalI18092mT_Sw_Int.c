...
/* static const uint16_t PH_MEMLOC_CONST_ROM aI18092_mT_FsTable[4] = {64, 128, 192, 253};
...
*  field.
*  */
static const uint16_t PH_MEMLOC_CONST_ROM aI18092_mT_FsTable[4] = {65, 129, 193, 255};
    ...
    )
{
    ...
    if (wFrameLength > aI18092_mT_FsTable[pDataParams->bLrt])
    {
