...
phStatus_t phpalI18092mT_Sw_DeInit(
    phpalI18092mT_Sw_DataParams_t * pDataParams
    )
{
    ...
    if (pDataParams->Pal18092mTEventObj.EventHandle != NULL)
    {
        wStatus = phOsal_EventDelete(&pDataParams->Pal18092mTEventObj.EventHandle);
    }
