 ...
 */
#define NUMBER_OF_KEYENTRIES        6U
...
static uint8_t          aSeed[SEED_COUNT];
    ...
    defined (NXPBUILD__PHAL_MFDFEVX_SAM_NONX) || defined (NXPBUILD__PHAL_MFPEVX_SAM_NONX)
...
#if defined(NXPBUILD__PHAL_MFDFEVX_SW) || defined(NXPBUILD__PHAL_MFPEVX_SW) || defined(NXPBUILD__PHAL_MFDFLIGHT_SW)
