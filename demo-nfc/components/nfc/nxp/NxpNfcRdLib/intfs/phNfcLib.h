...
#if defined (NXPBUILD__PHAL_ICODE_SW) || defined (NXPBUILD__PHAL_ICODE_SAM_NONX)
#include <phalICode.h>
#endif /* defined (NXPBUILD__PHAL_ICODE_SW) || defined (NXPBUILD__PHAL_ICODE_SAM_NONX) */
...
#if defined (NXPBUILD__PHAL_MFDFEVX_SW) || defined (NXPBUILD__PHAL_MFDFEVX_SAM_NONX)
#include <phalMfdfEVx.h>
#endif /* defined (NXPBUILD__PHAL_MFDFEVX_SW) || defined (NXPBUILD__PHAL_MFDFEVX_SAM_NONX) */

#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
#include <phalMfdfLight.h>
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */

#if defined (NXPBUILD__PHAL_MFPEVX_SW) || defined (NXPBUILD__PHAL_MFPEVX_SAM_NONX)
#include <phalMfpEVx.h>
#endif /* defined (NXPBUILD__PHAL_MFPEVX_SW) || defined (NXPBUILD__PHAL_MFPEVX_SAM_NONX) */

#ifdef NXPBUILD__PH_TMIUTILS
#include <phTMIUtils.h>
#endif  /* NXPBUILD__PH_TMIUTILS */

#if defined(NXPBUILD__PHAL_VCA_SW) || defined(NXPBUILD__PHAL_VCA_SAM_NONX)
#include <phalVca.h>
#endif /* defined(NXPBUILD__PHAL_VCA_SW) || defined(NXPBUILD__PHAL_VCA_SAM_NONX) */
...
#if defined (NXPBUILD__PHAL_MFUL_SW) || defined(NXPBUILD__PHAL_MFUL_SAM_NONX)
#include <phalMful.h>
#endif /* defined (NXPBUILD__PHAL_MFUL_SW) || defined(NXPBUILD__PHAL_MFUL_SAM_NONX) */
...
/* Keystore Header */
#if defined (NXPBUILD__PH_KEYSTORE) || defined (NXPBUILD__PH_KEYSTORE_RC663) || defined (NXPBUILD__PH_KEYSTORE_SAMAV3)
#include <phKeyStore.h>
#endif /* defined (NXPBUILD__PH_KEYSTORE) || defined (NXPBUILD__PH_KEYSTORE_RC663) || defined (NXPBUILD__PH_KEYSTORE_SAMAV3) */
...
/**
 * @name Crypto Sym type
 *
 * \anchor nfc_lib_definitions_CryptoSym_type
 * \brief Option to get the addresses of various CryptoSym components. These options should be used for
 * \ref phNfcLib_GetDataParams_Extended "Extended GetDataParams" API.
 * \{
 */
#define PH_NFCLIB_COMP_CRYPTOSYM_TYPE_ENC           0x01U /**< Option to get the address of CryptoSym component initialized for Encryption/Decription */
#define PH_NFCLIB_COMP_CRYPTOSYM_TYPE_MAC           0x02U /**< Option to get the address of CryptoSym component initialized for MACing */
#define PH_NFCLIB_COMP_CRYPTOSYM_TYPE_DIVERSIFY     0x03U /**< Option to get the address of CryptoSym component initialized for Diversification */
...
/**
 * \anchor FSDI_configuration
 * This configuration is used to configure Frame Size Device Integer value if different Fsdi is required other than default.
 * Note: 1. This configuration need to be used after calling \ref phNfcLib_Init() API and before calling \ref phNfcLib_Config_EMVCo_Profile() API.
 *       2. This configuration is applicable only in #PH_NFCLIB_ACTIVATION_PROFILE_EMVCO. Valid values: 8 and 10 based on Platform.
 * \par Parameter Size
 * 1 Byte (\p uint8_t)
 * \par Allowed Values
 * \p 8 to configure Fsdi value to 8.
 * \p 10 to configure Fsdi value to 10.
 * \par Default Value
 * \p #PH_NXPNFCRDLIB_CONFIG_FSDI_VALUE
 */
#define PH_NFCLIB_CONFIG_EMVCO_PROF_FSDI                 0x11U

/**
 * \anchor FSCI_configuration
 * This configuration is used to configure maximum allowed Frame Size Card Integer value if different Fsci is required other than default.
 * Note: 1. This configuration need to be used after calling \ref phNfcLib_Init() API and before calling \ref phNfcLib_Config_EMVCo_Profile() API.
 *       2. This configuration is applicable only in #PH_NFCLIB_ACTIVATION_PROFILE_EMVCO. Valid values: 8 and 10 based on Platform.
 * \par Parameter Size
 * 1 Byte (\p uint8_t)
 * \par Allowed Values
 * \p 8 to configure Fsci value to 8.
 * \p 10 to configure Fsci value to 10.
 * \par Default Value
 * \p #PH_NXPNFCRDLIB_CONFIG_DEFAULT_FSCI_VALUE
 */
#define PH_NFCLIB_CONFIG_EMVCO_PROF_FSCI                 0x12U
 ...
 * \code
 * phNfcLib_Init();
 * /-/ Get the addresses of the CryptoSym component type Encryption/Decription.
 * phNfcLib_GetDataParams_Extended(PH_COMP_CRYPTOSYM, PH_NFCLIB_COMP_CRYPTOSYM_TYPE_ENC);
 * \endcode
 *
 * \return Pointer to the component's dataparam structure. NULL in case phNfcLib is not managing the component indicated by \p wComponent
 * or NFC library is in state RESET.
...
void* phNfcLib_GetDataParams_Extended(
                 uint16_t wComponent,     /**< [In] The component ID for which the data params pointer should be returned. For possible value refer to ph_Status.h, PH_COMP_* */
                 uint8_t  bComponentType  /**< [In] Supported values are
                                           *            - #PH_NFCLIB_COMP_CRYPTOSYM_TYPE_ENC
                                           *            - #PH_NFCLIB_COMP_CRYPTOSYM_TYPE_MAC
                                           *            - #PH_NFCLIB_COMP_CRYPTOSYM_TYPE_DIVERSIFY
                                           */
                 );
/**
 * \}
