...
/**
 * Set/Get the Divisor Receive Integer (DRI) for Type B tags in passive poll mode.
 *
 * Default is 0.
 *
 * Note: In discovery loop, after performing \ref phpalI14443p3b_Attrib, DRI param will be
 *       updated with currently applied(based on user Set config and Card bitrate capabilities)
 *       DRI value from 14443P3B layer, same will be provided to user when Get Config performed.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEB_DRI                        0x35U

/**
 * Set/Get the Divisor Send Integer (DSI) for Type B tags in passive poll mode.
 *
 * Default is 0.
 *
 * Note: In discovery loop, after performing \ref phpalI14443p3b_Attrib, DSI param will be
 *       updated with currently applied(based on user Set config and Card bitrate capabilities)
 *       DSI value from 14443P3B layer, same will be provided to user when Get Config performed.
 * */
...
/**
 * Set/Get the Divisor Receive Integer (DRI) for the 14443P4A tags in passive poll mode.
 *
 * Default is 0.
 *
 * Note: In discovery loop, after performing \ref phpalI14443p4a_ActivateCard, DRI param will be
 *       updated with currently applied(based on user Set config and Card bitrate capabilities)
 *       DRI value from 14443P4A layer, same will be provided to user when Get Config performed.
 * */
#define PHAC_DISCLOOP_CONFIG_TYPEA_I3P4_DRI                   0x43U

/**
 * Set/Get the Divisor Send Integer (DSI) for the 14443P4A tags in passive poll mode.
 *
 * Default is 0.
 *
 * Note: In discovery loop, after performing \ref phpalI14443p4a_ActivateCard, DSI param will be
 *       updated with currently applied(based on user Set config and Card bitrate capabilities)
 *       DSI value from 14443P4A layer, same will be provided to user when Get Config performed.
 * */
