...
typedef struct
{
     ...
     * RESPONSE Flags.
     *
     * This holds the value of \ref res_flags "response flag" field used for the
     * commands sent by the library.
     * */
    uint8_t bResFlags;
...
/**
* \brief Set / Get IC Manufacturer Code.
*/
#define PHPAL_SLI15693_CONFIG_ICMFGCODE           0x0009U

/**
* \brief Set / Get Operation Mode.
*/
#define PHPAL_SLI15693_CONFIG_OPE_MODE            0x000AU
/*@}*/
...
/**
* Tolerance Timeout Delta in microseconds in RdLib NFC mode.
* Note: As per NFC Forum Digital Protocol v2.3, DELTATVPOLL should be 50 milli sec.
* */
#define PHPAL_SLI15693_NFC_MODE_TIMEOUT_DELTA_US      50000U

/**
* Tolerance Timeout Delta in microseconds in RdLib ISO mode.
* */
#define PHPAL_SLI15693_ISO_MODE_TIMEOUT_DELTA_US      0x0000U
