...
typedef struct phceT4T_Sw_DataParams
{
    ...
    /**
     * Indicates T4T NDEF supported version.
     */
    uint8_t bVno;

    /**
     * Indicates the index from which Data to be written to the NDEF File starts.
     */
    uint16_t wWriteDataOffset;

    /**
     * Indicates the num of data bytes to be written to the NDEF File.
     */
    uint16_t wTxDataLen;
...
phStatus_t phceT4T_Sw_DeInit(
    phceT4T_Sw_DataParams_t * pDataParams      /**< [In] Pointer to this layer's parameter structure. */
    );
...
/**
 * Set/Get value of T4T version number.
 */
#define PHCE_T4T_CONFIG_VNO                               0x07U

/**
 * Version Number for T4T - Mapping version 3.0.
 */
#define PHCE_T4T_NDEF_SUPPORTED_VNO                       0x30U

/**
 * Version Number for T4T - Default Mapping version 2.0.
 */
#define PHCE_T4T_NDEF_SUPPORTED_VNO_20                    0x20U
/*@}*/
