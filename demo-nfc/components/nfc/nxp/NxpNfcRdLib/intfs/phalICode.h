...
#define phalICode_WriteEASID(pDataParams, bOption, pEasIdValue) \
        phalICode_Sw_WriteEAS_ID((phalICode_Sw_DataParams_t *)pDataParams, bOption, pEasIdValue)
...
#define phalICode_SetPassword(pDataParams, bOption, bPwdIdentifier, pXorPwd) \
        phalICode_Sw_SetPassword((phalICode_Sw_DataParams_t *)pDataParams, bOption, bPwdIdentifier, pXorPwd)

#define phalICode_WritePassword(pDataParams, bOption, bPwdIdentifier, pPwd) \
        phalICode_Sw_WritePassword((phalICode_Sw_DataParams_t *)pDataParams, bOption, bPwdIdentifier, pPwd)

#define phalICode_LockPassword(pDataParams, bOption, bPwdIdentifier) \
        phalICode_Sw_LockPassword((phalICode_Sw_DataParams_t *)pDataParams, bOption, bPwdIdentifier)

#define phalICode_ProtectPage(pDataParams, bOption, bPPAdd_PageNo, bProtectionStatus) \
        phalICode_Sw_ProtectPage((phalICode_Sw_DataParams_t *)pDataParams, bOption, bPPAdd_PageNo, bProtectionStatus)

#define phalICode_LockPageProtectionCondition(pDataParams, bOption, bPageNo) \
        phalICode_Sw_LockPageProtectionCondition((phalICode_Sw_DataParams_t *)pDataParams, bOption, bPageNo)
...
#define phalICode_Destroy(pDataParams, bOption, pXorPwd) \
        phalICode_Sw_Destroy((phalICode_Sw_DataParams_t *)pDataParams, bOption, pXorPwd)

#define  phalICode_EnablePrivacy(pDataParams, bOption, pXorPwd) \
        phalICode_Sw_EnablePrivacy((phalICode_Sw_DataParams_t *)pDataParams, bOption, pXorPwd)
...
#define phalICode_ReadConfig(pDataParams, bOption, bBlockAddr, bNoOfBlocks, ppData, pDataLen) \
        phalICode_Sw_ReadConfig((phalICode_Sw_DataParams_t *)pDataParams, bOption, bBlockAddr, bNoOfBlocks, ppData, pDataLen)
...
#define phalICode_ReadTT(pDataParams, bOption, ppResponse, pRespLen) \
        phalICode_Sw_ReadTT((phalICode_Sw_DataParams_t *)pDataParams, bOption, ppResponse, pRespLen)
...
#define phalICode_I2CMRead(pDataParams, bI2CParam, bDataLen, pData) \
        phalICode_Sw_I2CMRead((phalICode_Sw_DataParams_t *)pDataParams, bI2CParam, bDataLen, pData)

#define phalICode_I2CMWrite(pDataParams, bI2CParam, pData, bDataLen) \
        phalICode_Sw_I2CMWrite((phalICode_Sw_DataParams_t *)pDataParams, bI2CParam, pData, bDataLen)
