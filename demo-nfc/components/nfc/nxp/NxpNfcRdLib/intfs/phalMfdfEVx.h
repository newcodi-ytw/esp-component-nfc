...
typedef struct
{
    ...
    uint8_t bUid[15U];                                                          /**< Complete UID of the PICC. \cond !PUBLIC This will be updated when \ref phalMfdfEVx_GetCardUID interface is called. \endcond */
    uint8_t bUidLength;                                                         /**< Length of bytes available in bUid buffer. */
    uint8_t bSDMStatus;                                                         /**< Get / Set the SDM availability in the file. */
    uint8_t bReturn_FabID;                                                      /**< Get / Set the return of Fabrication Identifier. When Set will be utilized during GetVersion command exchange. */
...
/** @{ */
#define PHAL_MFDFEVX_COMMIT_TXN_OPTION_NOT_EXCHANGED                    0x00U   /**< Option byte is not exchanged to the PICC. */
#define PHAL_MFDFEVX_COMMIT_TXN_NO_TMC_TMV_RETURNED                     0x80U   /**< Option byte exchanged to PICC and represent no return of TMC and TMV. */
#define PHAL_MFDFEVX_COMMIT_TXN_TMC_TMV_RETURNED                        0x81U   /**< Option byte exchanged to PICC and represent return of TMC and TMV. */
/** @} */
...
/** @{ */
#define PHAL_MFDFEVX_ADDITIONAL_INFO                                    0x00A1U /**< Option for Getconfig/SetConfig to get/set additional info of a generic error or some some length exposed by interfaces. */
#define PHAL_MFDFEVX_WRAPPED_MODE                                       0x00A2U /**< Option for GetConfig/SetConfig to get/set current status of command wrapping in ISO 7816-4 APDUs. */
#define PHAL_MFDFEVX_SHORT_LENGTH_APDU                                  0x00A3U /**< Option for Getconfig/SetConfig to get/set current status of Short Length APDU wrapping in ISO 7816-4 APDUs. */
#define PHAL_MFDFEVX_RETURN_FAB_ID                                      0x00A4U /**< Option for GetConfig/SetConfig to get/set Fabrication Identifier of the product. This will be
                                                                                 *   utilized while performing \ref phalMfdfEVx_GetVersion "GetVersion" command.
                                                                                 */
/** @} */
