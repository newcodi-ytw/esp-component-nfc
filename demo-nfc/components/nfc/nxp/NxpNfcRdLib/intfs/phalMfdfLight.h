...
typedef struct
{
    ...
    uint8_t bSesAuthENCKey[24U];                                                /**< Session key for this authentication */
    uint8_t bKeyNo;                                                             /**< key number against which this authentication is done */
    uint8_t bIv[16U];                                                           /**< Max size of IV can be 16 bytes */
    uint8_t bAuthMode;                                                          /**< Authenticate (0x0A), AuthISO (0x1A), AuthAES (0xAA) */
    uint8_t pAid[3U];                                                           /**< Aid of the currently selected application */
    ...
    uint8_t bSesAuthMACKey[16U];                                                /**< Authentication MAC key for the session. */
    uint8_t bKeySessionAuthMaster[16U];                                         /**< Session Auth master key. */
    ...
    uint8_t bLastBlockBuffer[16U];                                              /**< Buffer to store last Block of encrypted data in case of chaining. */
...
/** @{ */
#define PHAL_MFDFLIGHT_ERR_FORMAT                       (PH_ERR_CUSTOM_BEGIN + 0U)   /**< MF DF Light Response - No changes done to backup files. */
#define PHAL_MFDFLIGHT_ERR_OUT_OF_EEPROM_ERROR          (PH_ERR_CUSTOM_BEGIN + 1U)   /**< MF DF Light Response - Insufficient NV-Memory. */
#define PHAL_MFDFLIGHT_ERR_NO_SUCH_KEY                  (PH_ERR_CUSTOM_BEGIN + 2U)   /**< MF DF Light Invalid key number specified. */
#define PHAL_MFDFLIGHT_ERR_PERMISSION_DENIED            (PH_ERR_CUSTOM_BEGIN + 3U)   /**< MF DF Light Current configuration/status does not allow the requested command. */
#define PHAL_MFDFLIGHT_ERR_APPLICATION_NOT_FOUND        (PH_ERR_CUSTOM_BEGIN + 4U)   /**< MF DF Light Requested AID not found on PICC. */
#define PHAL_MFDFLIGHT_ERR_BOUNDARY_ERROR               (PH_ERR_CUSTOM_BEGIN + 5U)   /**< MF DF Light Attempt to read/write data from/to beyond the files/record's limits. */
#define PHAL_MFDFLIGHT_ERR_COMMAND_ABORTED              (PH_ERR_CUSTOM_BEGIN + 6U)   /**< MF DF Light Previous cmd not fully completed. Not all frames were requested or provided by the PCD. */
#define PHAL_MFDFLIGHT_ERR_COUNT                        (PH_ERR_CUSTOM_BEGIN + 7U)   /**< MF DF Light Num. of applns limited to 28. No additional applications possible. */
#define PHAL_MFDFLIGHT_ERR_DUPLICATE                    (PH_ERR_CUSTOM_BEGIN + 8U)   /**< MF DF Light File/Application with same number already exists. */
#define PHAL_MFDFLIGHT_ERR_FILE_NOT_FOUND               (PH_ERR_CUSTOM_BEGIN + 9U)   /**< MF DF Light Specified file number does not exist. */
#define PHAL_MFDFLIGHT_ERR_PICC_CRYPTO                  (PH_ERR_CUSTOM_BEGIN + 10U)  /**< MF DF Light Crypto error returned by PICC. */
#define PHAL_MFDFLIGHT_ERR_PARAMETER_ERROR              (PH_ERR_CUSTOM_BEGIN + 11U)  /**< MF DF Light Parameter value error returned by PICC. */
#define PHAL_MFDFLIGHT_ERR_DF_GEN_ERROR                 (PH_ERR_CUSTOM_BEGIN + 12U)  /**< MF DF Light DesFire Generic error. Check additional Info. */
#define PHAL_MFDFLIGHT_ERR_DF_7816_GEN_ERROR            (PH_ERR_CUSTOM_BEGIN + 13U)  /**< MF DF Light ISO 7816 Generic error. Check Additional Info. */
#define PHAL_MFDFLIGHT_ERR_CMD_INVALID                  (PH_ERR_CUSTOM_BEGIN + 14U)  /**< MF DF Light ISO 7816 Generic error. Check Additional Info. */
/** @} */
...
/** @{ */
#define PHAL_MFDFLIGHT_COMMIT_TXN_NO_TMC_TMV_RETURNED                       0x00U   /**< Option byte is not exchanged to the PICC. */
#define PHAL_MFDFLIGHT_COMMIT_TXN_TMC_TMV_RETURNED                          0x01U   /**< Option byte exchanged to PICC and represent return of TMC and TMV. */
#define PHAL_MFDFLIGHT_COMMIT_TXN_INCLUDE_OPTION                            0x80U   /**< Option byte exchanged to PICC. This is to support the exchange of Option byte to PICC. */
/** @} */
