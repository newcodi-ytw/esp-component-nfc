...
typedef struct
{
    ...
    uint8_t pCardData[16U];                                                 /**< Card Data received from the Card. */
...
typedef enum
{
    ...
    VC_DF_NOT_AUTH                                                 = 0x03U, /**< State to indicate DESFire PICC in not authenticaed. */
    ...
    VC_MFP_AUTH_AES_SL1                                            = 0x08U, /**< State to indicate MIFARE Plus PICC authenticated in Security Level 1. */
...
typedef struct
{
    ...
    uint8_t  bSessionAuthMACKey[16U];                                       /**< Session Keys for Authentication of MAC. */
...
/** @{ */
#define PHAL_VCA_ISO_SELECT_SELECTION_DF_NAME                       0x04U   /**< Option mask to indicate the selection control as DFName. */
#define PHAL_VCA_ISO_SELECT_FCI_RETURNED                            0x00U   /**< Option mask to indicate the return of FCI information. */

#define PHAL_VCA_ISO_SELECT_VARIANT_PART1                           0x00U   /**< Option mask for complete VC selection in 1 part. */
#define PHAL_VCA_ISO_SELECT_VARIANT_PART2                           0x08U   /**< Option mask for complete VC selection in 2 part. */
#define PHAL_VCA_ISO_SELECT_DIV_DISABLED                            0x00U   /**< Default option mask to disable the diversification of VcSelect MAC or ENC key. */
#define PHAL_VCA_ISO_SELECT_ENC_KEY_DIV_INPUT                       0x01U   /**< Option mask to perform diversification of VC SelectENC key using the diversification input provided. */
#define PHAL_VCA_ISO_SELECT_MAC_KEY_DIV_INPUT                       0x02U   /**< Option mask to perform diversification of VC SelectMAC key using the diversification input provided. */
#define PHAL_VCA_ISO_SELECT_MAC_KEY_DIV_VCUID                       0x04U   /**< Option mask to perform diversification of VC SelectMAC key using Virtual Card Identifier. */
#define PHAL_VCA_ISO_SELECT_MAC_KEY_DIV_INPUT_VCUID                 0x06U   /**< Option mask to perform diversification of VC SelectMAC key using Virtual Card Identifier
...
/** @{ */
#define PHAL_VCA_PC_RNDC_PROVIDED                                   0x00U   /**< Option mask to indicate the Random number C is given by the user. */
#define PHAL_VCA_PC_RNDC_GENERATE                                   0x01U   /**< Option mask to indicate the Random number C to be generated by the library. */

#define PHAL_VCA_PC_NORMAL_PROCESSING                               0x00U   /**< Option mask to indicate VerifyProcessing should be Normal. */
#define PHAL_VCA_PC_RANDOM_PROCESSING                               0x02U   /**< Option mask to indicate VerifyProcessing should be Random. */
/** @} */
