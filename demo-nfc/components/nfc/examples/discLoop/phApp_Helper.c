...
void phApp_PrintTech(uint8_t TechType)
{
    ...
    case PHAC_DISCLOOP_POS_BIT_MASK_A:
        DEBUG_LOG_UI ("\tResolving Type A... \n");
        break;

    case PHAC_DISCLOOP_POS_BIT_MASK_B:
        DEBUG_LOG_UI ("\tResolving Type B... \n");
        break;

    case PHAC_DISCLOOP_POS_BIT_MASK_F212:
        DEBUG_LOG_UI ("\tResolving Type F with baud rate 212... \n");
        break;

    case PHAC_DISCLOOP_POS_BIT_MASK_F424:
        DEBUG_LOG_UI ("\tResolving Type F with baud rate 424... \n");
        break;

    case PHAC_DISCLOOP_POS_BIT_MASK_V:
        DEBUG_LOG_UI ("\tResolving Type V... \n");
        break;
...
void phApp_PrintTagInfo(phacDiscLoop_Sw_DataParams_t *pDataParams, uint16_t wNumberOfTags, uint16_t wTagsDetected)
{
    ...
    if (PHAC_DISCLOOP_CHECK_ANDMASK(wTagsDetected, PHAC_DISCLOOP_POS_BIT_MASK_A))
    {
        ...
        {
            DEBUG_LOG_UI("\tTechnology  : Type A");
            DEBUG_LOG_UI ("\n\t\tUID :");
    ...
    {
        DEBUG_LOG_UI("\tTechnology  : Type B");
    ...
    {
        DEBUG_LOG_UI("\tTechnology  : Type F");
    ...
    {
        DEBUG_LOG_UI("\tTechnology  : Type V / ISO 15693 / T5T");
    ...
    {
        DEBUG_LOG_UI("\tTechnology  : ISO 18000p3m3 / EPC Gen2");
...
void PrintErrorInfo(phStatus_t wStatus)
{
    ...
    {
    case PH_COMP_BAL:
        DEBUG_LOG_UI("\t PH_COMP_BAL");
        break;
    case PH_COMP_HAL:
        DEBUG_LOG_UI("\t PH_COMP_HAL");
        break;
    case PH_COMP_PAL_ISO14443P3A:
        DEBUG_LOG_UI("\t PH_COMP_PAL_ISO14443P3A");
        break;
    case PH_COMP_PAL_ISO14443P3B:
        DEBUG_LOG_UI("\t PH_COMP_PAL_ISO14443P3B");
        break;
    case PH_COMP_PAL_ISO14443P4A:
        DEBUG_LOG_UI("\t PH_COMP_PAL_ISO14443P4A");
        break;
    case PH_COMP_PAL_ISO14443P4:
        DEBUG_LOG_UI("\t PH_COMP_PAL_ISO14443P4");
        break;
    case PH_COMP_PAL_FELICA:
        DEBUG_LOG_UI("\t PH_COMP_PAL_FELICA");
        break;
    case PH_COMP_PAL_EPCUID:
        DEBUG_LOG_UI("\t PH_COMP_PAL_EPCUID");
        break;
    case PH_COMP_PAL_SLI15693:
        DEBUG_LOG_UI("\t PH_COMP_PAL_SLI15693");
        break;
    case PH_COMP_PAL_I18000P3M3:
        DEBUG_LOG_UI("\t PH_COMP_PAL_I18000P3M3");
        break;
    case PH_COMP_PAL_I18092MPI:
        DEBUG_LOG_UI("\t PH_COMP_PAL_I18092MPI");
        break;
    case PH_COMP_PAL_I18092MT:
        DEBUG_LOG_UI("\t PH_COMP_PAL_I18092MT");
        break;
    case PH_COMP_PAL_I14443P4MC:
        DEBUG_LOG_UI("\t PH_COMP_PAL_I14443P4MC");
        break;
    case PH_COMP_AC_DISCLOOP:
        DEBUG_LOG_UI("\t PH_COMP_AC_DISCLOOP");
        break;
    case PH_COMP_OSAL:
        DEBUG_LOG_UI("\t PH_COMP_OSAL");
        break;
    default:
        DEBUG_LOG_UI("\t 0x%x",(wStatus & PH_COMPID_MASK));
        break;
    }
    ...
    case PH_ERR_SUCCESS_INCOMPLETE_BYTE:
        DEBUG_LOG_UI("\t PH_ERR_SUCCESS_INCOMPLETE_BYTE");
        break;
    case PH_ERR_IO_TIMEOUT:
        DEBUG_LOG_UI("\t PH_ERR_IO_TIMEOUT");
        break;
    case PH_ERR_INTEGRITY_ERROR:
        DEBUG_LOG_UI("\t PH_ERR_INTEGRITY_ERROR");
        break;
    case PH_ERR_COLLISION_ERROR:
        DEBUG_LOG_UI("\t PH_ERR_COLLISION_ERROR");
        break;
    case PH_ERR_BUFFER_OVERFLOW:
        DEBUG_LOG_UI("\t PH_ERR_BUFFER_OVERFLOW");
        break;
    case PH_ERR_FRAMING_ERROR:
        DEBUG_LOG_UI("\t PH_ERR_FRAMING_ERROR");
        break;
    case PH_ERR_PROTOCOL_ERROR:
        DEBUG_LOG_UI("\t PH_ERR_PROTOCOL_ERROR");
        break;
    case PH_ERR_RF_ERROR:
        DEBUG_LOG_UI("\t PH_ERR_RF_ERROR");
        break;
    case PH_ERR_EXT_RF_ERROR:
        DEBUG_LOG_UI("\t PH_ERR_EXT_RF_ERROR");
        break;
    case PH_ERR_NOISE_ERROR:
        DEBUG_LOG_UI("\t PH_ERR_NOISE_ERROR");
        break;
    case PH_ERR_ABORTED:
        DEBUG_LOG_UI("\t PH_ERR_ABORTED");
        break;
    case PH_ERR_INTERNAL_ERROR:
        DEBUG_LOG_UI("\t PH_ERR_INTERNAL_ERROR");
        break;
    case PH_ERR_INVALID_DATA_PARAMS:
        DEBUG_LOG_UI("\t PH_ERR_INVALID_DATA_PARAMS");
        break;
    case PH_ERR_INVALID_PARAMETER:
        DEBUG_LOG_UI("\t PH_ERR_INVALID_PARAMETER");
        break;
    case PH_ERR_PARAMETER_OVERFLOW:
        DEBUG_LOG_UI("\t PH_ERR_PARAMETER_OVERFLOW");
        break;
    case PH_ERR_UNSUPPORTED_PARAMETER:
        DEBUG_LOG_UI("\t PH_ERR_UNSUPPORTED_PARAMETER");
        break;
    case PH_ERR_OSAL_ERROR:
        DEBUG_LOG_UI("\t PH_ERR_OSAL_ERROR");
        break;
    case PHAC_DISCLOOP_LPCD_NO_TECH_DETECTED:
        DEBUG_LOG_UI("\t PHAC_DISCLOOP_LPCD_NO_TECH_DETECTED");
        break;
    case PHAC_DISCLOOP_COLLISION_PENDING:
        DEBUG_LOG_UI("\t PHAC_DISCLOOP_COLLISION_PENDING");
        break;
    default:
        DEBUG_LOG_UI("\t 0x%x",(wStatus & PH_ERR_MASK));
        break;
    }
}
